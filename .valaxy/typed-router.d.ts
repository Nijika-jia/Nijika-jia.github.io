...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/ablums/gallery1': RouteRecordInfo<'/ablums/gallery1', '/ablums/gallery1', Record<never, never>, Record<never, never>>,
    '/ablums/gallery2': RouteRecordInfo<'/ablums/gallery2', '/ablums/gallery2', Record<never, never>, Record<never, never>>,
    '/ablums/gallery3': RouteRecordInfo<'/ablums/gallery3', '/ablums/gallery3', Record<never, never>, Record<never, never>>,
